...
def train_RETAIN(
    ...
    if useTime and embFineTune:
        print
        'using time information, fine-tuning code representations'
        ...
        print
        'using time information, not fine-tuning code representations'
        ...
        print
        'not using time information, fine-tuning code representations'
        ...
        print
        'not using time information, not fine-tuning code representations'
        W_emb = theano.shared(params['W_emb'], name='W_emb')
    ...
    for epoch in xrange(max_epochs):
        ...
        for index in random.sample(range(n_batches), n_batches):
            ...
            if (iteration % 10 == 0) and verbose:
                print
                'Epoch:%d, Iteration:%d/%d, Train_Cost:%f' % (epoch, iteration, n_batches, costValue)
            iteration += 1
